...
def create_or_update_general_settings(general_settings_payload: Dict, workspace_id):
    ...
    if workspace_general_settings:
        map_merchant_to_vendor = WorkspaceGeneralSettings.objects.filter(workspace_id=workspace_id).first()
    ...
    if general_settings.map_merchant_to_vendor and \
        ...
        bank_transaction_expense_group_fields = expense_group_settings.corporate_credit_card_expense_group_fields
        bank_transaction_expense_group_fields.append('expense_id')

        expense_group_settings.corporate_credit_card_expense_group_fields = bank_transaction_expense_group_fields
