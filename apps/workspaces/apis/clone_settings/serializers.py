...
class CloneSettingsSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated):
        ...
        if (
            export_settings_serializer.is_valid(raise_exception=True)
            and import_settings_serializer.is_valid(raise_exception=True)
            and advanced_settings_serializer.is_valid(raise_exception=True)
        ):
