...
class GeneralMappingsSerializer(serializers.ModelSerializer):
    ...
    def get_bank_account(self, instance):
        return {"id": instance.bank_account_id, "name": instance.bank_account_name}
...
class ExpenseGroupSettingsSerializer(serializers.ModelSerializer):
    ...
    reimbursable_expense_state = serializers.CharField(
        allow_null=True, allow_blank=True, required=False
    )
...
class ExportSettingsSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated):
        ...
        if workspace_general_settings_instance:
            map_merchant_to_contact = (
                workspace_general_settings_instance.map_merchant_to_contact
            )
        ...
        (
            ...
            defaults={
                ...
                "reimbursable_expenses_object": workspace_general_settings[
                    "reimbursable_expenses_object"
                ],
                "corporate_credit_card_expenses_object": workspace_general_settings[
                    "corporate_credit_card_expenses_object"
                ],
        ...
        expense_group_settings_instance = ExpenseGroupSettings.objects.get(
            workspace_id=workspace_id
        )
        expense_group_settings[
            "expense_state"
        ...
        expense_group_settings[
            "reimbursable_expense_group_fields"
        ] = expense_group_settings_instance.reimbursable_expense_group_fields
        expense_group_settings[
            "corporate_credit_card_expense_group_fields"
        ] = expense_group_settings_instance.corporate_credit_card_expense_group_fields

        if (
            "expense_state" in expense_group_settings
            and not expense_group_settings["expense_state"]
        ):
    ...
    def validate(self, data):
        ...
        if (
            data["workspace_general_settings"]["corporate_credit_card_expenses_object"]
            == "BANK TRANSACTION"
