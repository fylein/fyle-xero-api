...
class XeroConnector:
    ...
    def __construct_bill(self, bill: Bill, bill_lineitems: List[BillLineItem]) -> Dict:
        ...
        bill_payload = {
            ...
            "Url": f'{settings.FYLE_APP_URL}/app/admin/#/company_expenses?txnId={bill_lineitems[0].expense.expense_id}&org_id={workspace.fyle_org_id}' if settings.BRAND_ID == 'fyle' else None,
    ...
    def __construct_bank_transaction(
        ...
        bank_transaction_payload = {
            ...
            "Url": f'{settings.FYLE_APP_URL}/app/admin/#/company_expenses?txnId={bank_transaction_lineitems[0].expense.expense_id}&org_id={workspace.fyle_org_id}' if settings.BRAND_ID == 'fyle' else None,
            "LineAmountTypes": "Exclusive"
            if general_settings.import_tax_codes
            else "NoTax",
