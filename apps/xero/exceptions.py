...
from apps.workspaces.models import XeroCredentials, FyleCredential, LastExportDetail
from fyle_xero_api.exceptions import BulkError

from xerosdk.exceptions import WrongParamsError, InvalidTokenError, NoPrivilegeError, UnsuccessfulAuthentication, XeroSDKError, RateLimitError
    ...
    def decorator(func):
        def new_fn(*args):
            ...
            try:
                ...
                detail = {
                    'message': 'Xero Account not connected / token expired'
                }
