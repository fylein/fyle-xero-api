...
class TenantMapping(models.Model):
    ...
    tenant_name = models.CharField(max_length=255, help_text='Xero Tenant name', null=True)
    tenant_id = models.CharField(max_length=255, help_text='Xero Tenant id', null=True)
