...
def test_get_bank_transaction_view(api_client, test_connection):
    workspace_id = 1

    access_token = test_connection.access_token
    url = '/api/workspaces/{}/xero/bank_transactions/'.format(workspace_id)
...
def test_get_bill_view(api_client, test_connection):
    ...
    access_token = test_connection.access_token
    url = '/api/workspaces/{}/xero/bills/'.format(workspace_id)
