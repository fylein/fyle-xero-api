...
def test_create_bill(db):
    ...
    for bill_lineitem in bill_lineitems:
        ...
        assert (
            ...
            == "sravan.kumar@fyle.in, category - Food spent on 2020-01-01, report number - C/2022/06/R/1  - https://staging.fyle.tech/app/main/#/enterprise/view_expense/txGilVGolf60?org_id=orPJvXuoLqvJ"
        )
...
def test_get_expense_purpose(db):
    ...
    for lineitem in expenses:
        ...
        assert (
            expense_purpose
            == "sravan.kumar@fyle.in, category - WIP / None spent on 2022-05-25, report number - C/2022/05/R/13  - https://staging.fyle.tech/app/main/#/enterprise/view_expense/txBMQRkBQciI?org_id=orPJvXuoLqvJ"
        )
